...
export default function ServiceCard({item} : Props){
    return(
        <Link href={`/service/reservation/${item.slug}`} className="bg-[var(--surface)] 
         ...
         border border-[var(--border)] shadow-md">
             <Image unoptimized src={item.image} width={800} height={600} 
             ...
             <div className="py-3 px-3 flex flex-col gap-1.5">
                ...
                group-hover:text-[var(--primary)]  font-bold">{item.name}</h2>
