...
import { FaFemale, FaList, FaTimes } from "react-icons/fa";
...
export default function ServiceModal({ open, setOpen , setService , service }: Props) {
                  ...
                  <div className="pr-10">
                    <div className="mb-2 flex items-center gap-2">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[var(--primary)]/10">
                        <FaList className="h-5 w-5 text-[var(--primary)]" />
                      </div>
                    ...
                    <p className="mt-2 max-w-lg text-sm leading-6 text-[var(--secondary-text)]">
                      Select the beauty service you are looking for and discover
                      the best salons for it.
                    </p>
                  </div>
